...
欢迎使用 Vafast - 超高性能的 TypeScript Web 框架！
...
### 🎯 架构设计
- [路由设计与网关架构](./router-design.md) - 核心设计文档
  - 声明式 vs 链式路由对比
  - 声明式路由的战略优势
  - AI 时代的路由能力
  - 作为网关的优势
- [本地工具模式](./local-tools-mode.md) - AI 工具专题
  - 声明式路由作为 AI Tools
  - 无需 HTTP 服务的本地执行
  - AI 调用工具流程详解
  - 实际应用场景
...
- [SSE 流式响应](./sse.md) - Server-Sent Events 支持
  - 通过 `sse: true` 显式声明 SSE 端点
  - 支持 GET + query 和 POST + body 两种场景
  - AI 聊天、进度更新等实际场景
