...
6. [AI 时代的路由能力](#ai-时代的路由能力)
7. [作为网关的优势](#作为网关的优势)

### 相关文档

- [本地工具模式](./local-tools-mode.md) - 声明式路由作为本地 AI 工具，无需 HTTP 服务
...
> 📖 **延伸阅读**：[本地工具模式](./local-tools-mode.md) - 不启动 HTTP 服务，直接本地调用，适用于桌面 AI 助手、Electron 应用等场景。
