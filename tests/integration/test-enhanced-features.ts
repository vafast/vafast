...
const routes: Route[] = [
  ...
  // 测试方法不匹配
  {
    method: "GET",
    path: "/method-test",
    handler: () => json({ message: "GET方法" }),
  },
  {
    method: "POST",
    path: "/method-test",
    handler: () => json({ message: "POST方法" }),
  },
  ...
  // 测试多种响应类型
  {
    method: "GET",
    path: "/response/text",
    handler: () => text("这是纯文本响应"),
  },
  {
    method: "GET",
    path: "/response/html",
    handler: () => html("<h1>这是HTML响应</h1>"),
  },
  ...
  {
    method: "GET",
    path: "/url-encoded/test",
    handler: () => json({ message: "URL编码测试" }),
  },
